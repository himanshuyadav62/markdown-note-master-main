...
import { NotePencilIcon, CheckCircleIcon, MoonIcon, SunIcon, GoogleLogoIcon, SignOutIcon, ShareNetworkIcon } from '@phosphor-icons/react';
...
function App() {
  ...
  const handleTabChange = (tab: ActiveTab) => {
    setActiveTab(tab);
    navigate(`/${tab === 'workflows' ? 'workflows' : tab}`);
  };
          ...
          <div className="flex items-center gap-3">
            <Tabs value={activeTab} onValueChange={(v) => handleTabChange(v as ActiveTab)}>
              <TabsList>
                ...
                <TabsTrigger value="workflows" className="hidden sm:flex">
